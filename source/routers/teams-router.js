...
router.get("/", controller.getAll)
      ...
      .get("/update/:id", authorizedInterceptor, authorizedInterceptor, teamInterceptor, teamOwnerIntercetor, controller.getTeamForUpdateById)
      .post("/:id", authorizedInterceptor, authorizedInterceptor, teamInterceptor, teamOwnerIntercetor, controller.update)
